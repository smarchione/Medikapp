					...
					switch ($opc)
						{
							...
							case 3:
							// acá coloco la opción de alta de instituciones
								include_once('institucion_alta.php');
								break;
							
							case 4:
							// acá coloco la opción de baja de instituciones
								include_once('institucion_baja.php');
								break;
							case 5:
							// acá coloco la opción de modificación de instituciones
								include_once('institucion_modi.php');
								break;

							case 6:
							// acá coloco la opción de alta de profesionales
								include_once('prof_alta1.php');
								break;
